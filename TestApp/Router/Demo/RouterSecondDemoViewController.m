//
//  RouterSecondDemoViewController.m
//  TestApp
//
...
@interface RouterSecondDemoViewController ()

@end

@implementation RouterSecondDemoViewController


+ (void)load{
    
    [[ViewControllerRegister sharedSingleton] registerUrl:RouterSecondDemoUrl withViewControllerClassName:NSStringFromClass(self)];
